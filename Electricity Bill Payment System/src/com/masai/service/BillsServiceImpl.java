...
public class BillsServiceImpl implements BillsService {
	...
	@Override
	public List<Bills> viewConsumerBills(String email, List<Bills> bills)
			throws BillsException {
...
//				myTr.add(tr);
	...
	public List<Bills> payConsumerBills(String email, List<Bills> bills)
			throws BillsException {
		// TODO Auto-generated method stub
		List<Bills> myTr = new ArrayList<>();
		boolean ans = false;
...
//				myTr.add(tr);
		...
		if(!ans)throw new BillsException("You already paid your bill");
	}
